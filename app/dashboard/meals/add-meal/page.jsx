          ...
          <div className="flex-1 bg-[#1B2537] rounded p-4">
            <div className="font-semibold flex justify-between py-2 pb-6 px-2 border-b-[1px] border-slate-900">
              ...
              <span className="flex gap-2 items-center">
                Combo
                <StatusRadio value={isCombo} onChange={() => setIsCombo(!isCombo)} />
              </span>
            </div>
          ...
          <div className="flex-1 bg-[#1B2537] rounded p-4">
            ...
            <div className="py-4">
              <Image
                ...
                width={400}
                height={400}
                className={`rounded w-[300px] min-w-[300px] max-w-[300px] h-[300px] object-cover  ${!mealImage && "opacity-60"}`}
              />
            </div>
